...
def gen_overview(stats: dict) -> str:
    ...
    return (
        ...
        '                    <stop offset="0%" stop-color="#1A3870" stop-opacity="0.72" />\n'
        '                    <stop offset="52%" stop-color="#2D5F9E" stop-opacity="0.52" />\n'
        '                    <stop offset="100%" stop-color="#4A8AC4" stop-opacity="0.38" />\n'
        '                </linearGradient>\n'
        ...
        '                    <feDropShadow dx="0" dy="4" stdDeviation="14" flood-color="#0a1628" flood-opacity="0.28" />\n'
...
def gen_repo_card(repo: dict, index: int = 0) -> str:
    ...
    return (
        ...
        '                <feDropShadow dx="0" dy="3" stdDeviation="10" flood-color="#0a1628" flood-opacity="0.26" />\n'
        '            </filter>\n'
        "        </defs>\n"
